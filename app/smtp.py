...
def sendInternalEmails(email):
    try:
        ...
        msg['To'] = 'vinicius@modallport.com.br' #email['TO_ADDRESS']

        if email['UTILIZA_LAYOULT'] == 'S':
                                    ...
                                    <tr>
                                        <td align="center" valign="top" style="padding: 10px 0;" class="logo">
                                            <a href="http://www.modallport.com.br" target="_blank">
                                                <img alt="Logo" src="http://189.114.222.36:81/notificacaointerna/logo_pequeno.png" width="60" height="60" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;" border="0">
                                            </a>
                                        </td>
                                    </tr>
                                </table>
            ...
            """).format(email['SUBJECT'], email['DESC_MENSAGEM'])
        ...
        s.sendmail(email['FROM_ADDRESS'], 'vinicius@modallport.com.br', msg.as_string())
        print('opa')
        s.quit()
